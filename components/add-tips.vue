	...
	<view>
		...
		<view class='modal' v-if="SHOW_MODAL">
			<view style='flex-direction: row;align-items:center; margin-top: 40px;'>
				<text>1. 点击</text>
				<image src='/static/images/addTips/fav-1.jpg' style='width:100px;height:40px;'></image>
			</view>
			<view>
				<text>2. 点击「添加到我的小程序」</text>
				<image src='/static/images/addTips/fav-2.jpg' mode="widthFix" style='width: 650rpx;'></image>
			</view>
			<view>
